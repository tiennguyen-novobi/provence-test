...
@register_model('product_attribute_terms')
class WooCommerceProductAttributeTermModel(
    ...
    """
    An interface of WooCommerce product attribute terms
    """
    prefix = 'products/attributes/{attribute_id}/'
    path = 'terms'
    primary_key = 'id'
    
    secondary_keys = ('attribute_id',)
