...
def test_get_product_image_information_called():
    api = bigcommerce.connect_with(CREDENTIALS)
    ack = api.product_images.acknowledge(None, product_id=123)
    ...
    mock_request.assert_called_once_with(
        'GET',
        f'https://api.bigcommerce.com/stores/{STORE_HASH}/v3/catalog/products/123/images',
