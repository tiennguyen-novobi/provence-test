...
def test_get_shipment_information_called():
    api = bigcommerce.connect_with(CREDENTIALS)
    ack = api.order_shipment.acknowledge(None, order_id=123)
    ...
    mock_request.assert_called_once_with(
        'GET',
        f'https://api.bigcommerce.com/stores/{STORE_HASH}/v2/orders/123/shipments',
