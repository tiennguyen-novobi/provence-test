...
def test_get_order_tax_information_called():
    api = bigcommerce.connect_with(CREDENTIALS)
    ack = api.order_taxes.acknowledge(None, order_id=123)
    ...
    mock_request.assert_called_once_with(
        'GET',
        f'https://api.bigcommerce.com/stores/{STORE_HASH}/v2/orders/123/taxes',
