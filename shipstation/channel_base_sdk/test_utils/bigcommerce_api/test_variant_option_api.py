...
def test_get_variant_option_information_called():
    api = bigcommerce.connect_with(CREDENTIALS)
    ack = api.variant_options.acknowledge(None, product_id=123)
    ...
    mock_request.assert_called_once_with(
        'GET',
        f'https://api.bigcommerce.com/stores/{STORE_HASH}/v3/catalog/products/123/options',
